...
class myApp(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # combo.addItem('Kayseri')
        # combo.addItem('İzmir')
        # combo.addItems(['Bursa','Rize','Sivas'])


        self.ui.btn_load_item.clicked.connect(self.LoadItems)
        self.ui.btn_get_item.clicked.connect(self.GetItem)
        self.ui.btn_clear_items.clicked.connect(self.ClearItem)
